...
public abstract class CellNet : NetworkBehaviour, IGraphNode
{
    [HideInInspector]
    [SerializeField]
    [SyncVar]
    ...
    /// </summary>
    public abstract int GetDistance(CellNet other);

    /// <summary>
    /// Method returns cells adjacent to current cell, from list of cells given as parameter.
    /// </summary>
    public abstract List<CellNet> GetNeighbours(List<CellNet> cells);
